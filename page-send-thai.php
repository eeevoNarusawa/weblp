...
<html>
  <head>
    ...
    <meta http-equiv="refresh" content="5; url=<?php echo home_url(); ?>/thai">
  ...
  <body>
    ...
    <nav>
      <ul>
        <li><a href="<?php echo home_url(); ?>/thai#characteristic">eeevoの特徴</a></li>
        <li><a href="<?php echo home_url(); ?>/thai#ourWorks">our works</a></li>
        <li><a href="<?php echo home_url(); ?>/thai#reason">選ばれる理由</a></li>
        <li><a href="<?php echo home_url(); ?>/thai#price">料金プラン</a></li>
        <li><a href="<?php echo home_url(); ?>/thai#flow">制作の流れ</a></li>
        <li><a href="<?php echo home_url(); ?>/thai#faq">FAQ</a></li>
        <li><a href="<?php echo home_url(); ?>/thai#contact">お問い合わせ</a></li>
      </ul>
    </nav>
